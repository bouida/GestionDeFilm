...
namespace Proxies\__CG__\FilmBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Acteur extends \FilmBundle\Entity\Acteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FilmBundle\\Entity\\Acteur' . "\0" . 'id', '' . "\0" . 'FilmBundle\\Entity\\Acteur' . "\0" . 'nom', '' . "\0" . 'FilmBundle\\Entity\\Acteur' . "\0" . 'prenom', '' . "\0" . 'FilmBundle\\Entity\\Acteur' . "\0" . 'datenaissance', '' . "\0" . 'FilmBundle\\Entity\\Acteur' . "\0" . 'sexe'];
        }
